...
namespace Microsoft.MixedReality.Toolkit.Editor
{
	...
	public class MixedRealityOptimizeWindow : EditorWindow
	{
		...
		private void OnGUI()
		{
			...
			if (!Microsoft.MixedReality.Toolkit.Utilities.Editor.XRSettingsUtilities.LegacyXREnabled)
			{
				...
				{
					Microsoft.MixedReality.Toolkit.Utilities.Editor.XRSettingsUtilities.LegacyXREnabled = true;
				}
			}
			else
			{
